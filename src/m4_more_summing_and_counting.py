...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 5
    answer = count_cosines_from(0, 9, 0)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(4, 8, 0.29)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(-2,2,0)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(10,15,.8)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.7179  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 8)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
